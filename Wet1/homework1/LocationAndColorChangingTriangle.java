 ...
 * properties: {location, color, shape, size, velocity,x.cordinates,y.cordinates}
 */
public class LocationAndColorChangingTriangle extends ColorAndLocationChangingShape {
    ...
    public Object clone() {
    	checkRep();
    	LocationAndColorChangingTriangle cloneObject = (LocationAndColorChangingTriangle)super.clone();
    	cloneObject.size = (Rectangle)this.size.clone();
    	cloneObject.xPointsOfTriangle = xPointsOfTriangle.clone(); // shallow copy of integers 
    	cloneObject.yPointsOfTriangle = yPointsOfTriangle.clone(); // shallow copy of integers 
    	checkRep();
        return cloneObject;
    }
